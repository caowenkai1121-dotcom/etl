...
/**
 * MySQL连接器 - 使用HikariCP连接池
 */
@Slf4j
public class MySQLConnector extends AbstractConnector {

    private static final String JDBC_URL_TEMPLATE = "jdbc:mysql://%s:%d/%s?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=Asia/Shanghai&allowPublicKeyRetrieval=true&connectionCollation=utf8mb4_unicode_ci";

    // 连接池名称
    private final String poolName;

    public MySQLConnector(Long datasourceId, String host, Integer port, String databaseName,
        ...
        this.poolName = "mysql-pool-" + datasourceId;
    }
    ...
    public void close() {
        ...
        log.info("关闭MySQL连接池: poolName={}", poolName);
    }
